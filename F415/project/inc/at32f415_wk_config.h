...
#define DMA1_CHANNEL1_MEMORY_BASE_ADDR   (uint32_t)UART_1.USART_RX_Buff
...
#define DMA1_CHANNEL3_BUFFER_SIZE   512
#define DMA1_CHANNEL3_MEMORY_BASE_ADDR   (uint32_t)UART_2.USART_RX_Buff
...
#define DMA1_CHANNEL5_BUFFER_SIZE   512
#define DMA1_CHANNEL5_MEMORY_BASE_ADDR   (uint32_t)UART_3.USART_RX_Buff
